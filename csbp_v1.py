...
from source.widgets.table import StoryboardTable
from source.widgets.player import PlayerWindow

from source.internal.project import *


class StoryboardPlannerMainWindow(QMainWindow):
    def __init__(self):
        super(StoryboardPlannerMainWindow, self).__init__(None)
...
class StoryBoardPlanner(object):

    def __init__(self, argv:list[str]=[]) -> None:
        self.__app = QApplication(argv)
        self.__mainWindow = StoryboardPlannerMainWindow()
...
if __name__ == "__main__":
    app = StoryBoardPlanner(sys.argv)
    sys.exit(app.run())
